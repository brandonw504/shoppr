...
class ScanningViewController: UIViewController {
    ...
    // MARK: - Delegate
    weak public var delegate: UIScanningViewControllerDelegate?
    ...
    func configureNavBar() {
        ...
        let navItem = UINavigationItem(title: "Scan Price")
        let doneItem = UIBarButtonItem(barButtonSystemItem: .done, target: nil, action: #selector(pressed))
        navItem.rightBarButtonItem = doneItem
        navBar.setItems([navItem], animated: false)
        
        addNavBarConstraints()
    }
    
    func addNavBarConstraints() {
